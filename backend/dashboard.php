            ...
            <div class="col-sm-8 flex-column d-flex stretch-card">
              <div class="row">
                <div class="col-lg-4 d-flex grid-margin stretch-card">
                  <?php
                    // Fetch the highest bid and its date
                    ...
                    if ($row = mysqli_fetch_assoc($result)) {
                        $highestBid = '$'.number_format($row['bid_price']); // format if needed
                        $bidDate = date('F Y', strtotime($row['created_at'])); // e.g., "April 2019"
                    } else {
                        $highestBid = "0";
                        $bidDate = "";
                    }
                ...
                <div class="card bg-primary">
                  <div class="card-body">
                    <h2 class="text-white mb-2 font-weight-bold"><?= $highestBid ?></h2>
                    <h4 class="card-title mb-2 text-white">Highest Bid Amount</h4>
                    <small style="color: aqua;"><?= $bidDate ?></small>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-4 d-flex grid-margin stretch-card">
                  ...
                  $result = mysqli_query($dbcon, "SELECT COUNT(*) AS total_users FROM users");
                  ...
                  <div class="card blue">
                    <div class="card-body">
                      <h2 class="text-dark mb-2 font-weight-bold"><?= $totalUsers ?></h2>
                ...
                <div class="col-lg-4 d-flex grid-margin stretch-card">
                  <?php
                  // Fetch total number of users
                  $result = mysqli_query($dbcon, "SELECT COUNT(*) AS total_categories FROM categories");
                  $row = mysqli_fetch_assoc($result);
                  $totalCategories = $row['total_categories'];
                  ?>
                  <div class="card green">
                    <div class="card-body">
                      <h2 class="text-dark mb-2 font-weight-bold"><?= $totalCategories; ?></h2>
                ...
                <div class="col-lg-4 d-flex grid-margin stretch-card">
                  <?php
                  // Fetch total number of users
                  $result = mysqli_query($dbcon, "SELECT COUNT(*) AS total_products FROM products");
                  $row = mysqli_fetch_assoc($result);
                  $totalProducts = $row['total_products'];
                  ?>
                  <div class="card">
                    <div class="card-body">
                      <h2 class="text-dark mb-2 font-weight-bold"><?= $totalProducts; ?></h2>
